        ...
        <div className="flex flex-wrap gap-3 md:gap-4">
          {[
            ...
            <a
              ...
              className="text-surface-variant hover:text-primary-fixed border-[2px] border-surface-variant hover:border-primary-fixed p-2.5 transition-[color,transform,border-color] duration-150 ease-[var(--ease-out)] active:scale-95 inline-flex items-center justify-center touch-target"
            >
              {social.icon}
            </a>
          ))}
